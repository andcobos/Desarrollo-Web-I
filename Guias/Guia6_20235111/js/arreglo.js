...
function ordenarElementos() {
    ...
    for (let i of arreglo.sort((a,b)=>a-b)) { //arrow function, el sort sin oparametros lo ordena por criterios de canea, por eso le ponemos una funcion de comparacion con el a,b => a-b
